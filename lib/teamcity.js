...
module.exports = function(runner) {
  ...
  runner.on('end', function() {
    ...
    if (!data) {
      return console.log(`##teamcity[message text='CODE-COVERAGE CHECK FAILED' errorDetails='Error reading report file.' status='ERROR']`);
    }

    const cov = Math.ceil(data.coverage);
